...
5. Use `./scripts/import-repo-knowledge.ps1 -RepoUrl <github-url>` to scaffold a first-pass bundle when you want repeatable automation.
6. Refresh the external bridge template at `.github/skills/repo-knowledge-loader/templates/external-bridge-skill.md` or the generated `.ai/repo-imports/<repo-slug>/external-bridge-skill.md` when another repository must reference the bundle.
